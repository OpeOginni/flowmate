    ...
    async (network: FlowNetwork) => {
      ...
      try {
        ...
        fcl.config({
          ...
          "app.detail.url": process.env.NEXT_PUBLIC_APP_DETAIL_URL,
          "app.detail.icon":
          ...
          flowJSON: {
            contracts: {
              stFlowToken: config.stFlowToken,
  ...
  return (
    <FlowProvider
      ...
      config={{
        ...
        appDetailTitle: "Flow Mate",
        appDetailUrl: process.env.NEXT_PUBLIC_APP_DETAIL_URL,
...
export default function FlowProviderWrapper({
  ...
  return (
    <NetworkSwitchProvider>
        <FlowProviderInner>{children}</FlowProviderInner>
    </NetworkSwitchProvider>
  )
}